...
class GLObject(val glslProgram: GLSL_Program,
    ...
    private val INFO_COMPONENT_COUNT = 2

    private val vertexArray = VertexArray(trianglesCoordinates)
    private val infoFloatArray = GLIntBuffer(trianglesInfo)
    ...
    fun bind_attribs() {
        ...
        /*
        infoFloatArray.setVertexAttribPointer(0, glslProgram._a_triangles_info,
            INFO_COMPONENT_COUNT, 0)
         */
    }
